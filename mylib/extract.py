...
def extract(
    url="https://raw.githubusercontent.com/ailina-aniwan/Ailina_Aniwan_Mini_Project_11/refs/heads/main/data/student_lifestyle_dataset.csv",
    file_path=FILESTORE_PATH + "/student_lifestyle_dataset.csv",
